...
import 'package:operations/common/client_process_card/client_process_card.dart';
...
class ClientTab extends GetView<InstallationDetailsScreenController> {
                ...
                : Column(
                    children: [
                      ...
                      ...controller.clientProcesses
                          .map((p) => ProcessClientCard(process: p)),
                    ],
                  ),
          ),
        ],
