...
class OperatingCommentsTab extends GetView<OperatingDetailsScreenController> {
  const OperatingCommentsTab({super.key});
          ...
          Container(
            ...
            child: Obx(
              () => controller.comments.isEmpty &&
                      !controller.isCommnetsLoading.value
                  ? const Center(
                  ...
                  : ListView.builder(
                      ...
                      itemCount: controller.comments.length +
                          (controller.isCommnetsLoading.value ? 1 : 0),
